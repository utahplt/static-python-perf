...
def check_stability(file_name, num_iterations):
...
if __name__ == "__main__":
    file_name = "/Users/Vivaan/Desktop/Static\\ Python/static-python-perf/Benchmark/richards/untyped/main.py"
    num_iterations = 8
    check_stability(file_name, num_iterations)
