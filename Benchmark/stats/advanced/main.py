...
print('\nCENTRAL TENDENCY')
print('geometricmean:', central_tendency.geometricmean(l), central_tendency.geometricmean(lf),
      central_tendency.geometricmean(l), central_tendency.geometricmean(lf))
print('harmonicmean:', central_tendency.harmonicmean(l), central_tendency.harmonicmean(lf),
      central_tendency.harmonicmean(l), central_tendency.harmonicmean(lf))
print('mean:', central_tendency.mean(l), central_tendency.mean(lf), central_tendency.mean(l), central_tendency.mean(lf))
print('median:', central_tendency.median(l), central_tendency.median(lf), central_tendency.median(l),
      central_tendency.median(lf))
print('medianscore:', central_tendency.medianscore(l), central_tendency.medianscore(lf),
      central_tendency.medianscore(l), central_tendency.medianscore(lf))
...
print(frequency.itemfreq(l))
print('scoreatpercentile:', frequency.scoreatpercentile(l, 40), frequency.scoreatpercentile(lf, 40),
      frequency.scoreatpercentile(l, 40), frequency.scoreatpercentile(lf, 40))
print('percentileofscore:', frequency.percentileofscore(l, 12), frequency.percentileofscore(lf, 12),
      frequency.percentileofscore(l, 12), frequency.percentileofscore(lf, 12))
...
print('sumsquared:', support.square_of_sums(l), support.square_of_sums(lf), support.square_of_sums(l),
      support.square_of_sums(lf))
print('sumdiffsquared:', support.sumdiffsquared(l, m), support.sumdiffsquared(lf, m), support.sumdiffsquared(l, l),
