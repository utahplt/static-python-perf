...
class ExchangeForSpecies(CardPlay):
    ...
    def __init__(self: ExchangeForSpecies, played_card_index: Int, loi: List[Int]) -> None:
        """
        ...
        self.loi: List[Int] = loi

    def apply(self: ExchangeForSpecies, player_state: PlayerState) -> None:
